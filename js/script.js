...
(function() {
  ...
  // --- Incoming: overlay starts fully covering (CSS scaleY(1)), animates to scaleY(0) ---
  // After the reveal animation finishes, hide overlay
  ...
  window.addEventListener('pageshow', function(e) {
    if (e.persisted) {
      // Page was restored from cache — re-reveal
  ...
  // --- Outgoing: click a link → overlay grows from bottom to cover page ---
